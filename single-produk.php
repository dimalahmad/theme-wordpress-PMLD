...
while (have_posts()) : the_post();
    ...
    $promo = get_post_meta($post_id, '_product_promo', true);
    ...
    if (!empty($original_price_raw)) {
        if (is_numeric($original_price_raw)) {
            $original_price = absint($original_price_raw);
        } else {
                ...
                <div class="hero-image-info-wrapper">
                    ...
                    <div class="hero-info-section">
                        ...
                        <div class="contact-person-card">
                            <?php 
                            // Get products-specific contact info, fallback to general contact
                            $wa_number = get_theme_mod('inviro_whatsapp', '6281234567890');
                            
                            // Get button text from customizer
                            $buy_button_text = get_theme_mod('inviro_products_buy_button', 'Beli atau Tanya Lebih Lanjut');
                        ...
                        <div class="tab-content-inner">
                            ...
                            <div class="review-form-wrapper">
                                ...
                                <form id="product-review-form" class="review-form">
                                    ...
                                    <input type="hidden" name="product_type" value="produk">
