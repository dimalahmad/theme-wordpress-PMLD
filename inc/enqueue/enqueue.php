...
function inviro_enqueue_files() {
    ...
    if (is_front_page()) {
        wp_enqueue_style('inviro-front-page', get_template_directory_uri() . '/assets/css/front-page.css', array('inviro-base', 'inviro-components-cards'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/front-page.css'));
        wp_enqueue_style('inviro-hero-fix', get_template_directory_uri() . '/assets/css/hero-section-fix.css', array('inviro-front-page'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/hero-section-fix.css'));
        // Product fix disabled - using front-page.css only for consistency
    } elseif (is_page('profil')) {
        wp_enqueue_style('inviro-profil', get_template_directory_uri() . '/assets/css/profil.css', array('inviro-base'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/profil.css'));
        wp_enqueue_style('inviro-front-page', get_template_directory_uri() . '/assets/css/front-page.css', array('inviro-base', 'inviro-components-cards'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/front-page.css'));
        wp_enqueue_style('inviro-hero-fix', get_template_directory_uri() . '/assets/css/hero-section-fix.css', array('inviro-front-page'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/hero-section-fix.css'));
    ...
    } elseif (is_page('paket-usaha') || is_page_template('page-paket-usaha.php') || is_page_template('page-paket-usaha-dummy-style.php') || is_post_type_archive('paket_usaha')) {
        wp_enqueue_style('inviro-paket-usaha', get_template_directory_uri() . '/assets/css/paket-usaha.css', array('inviro-base', 'inviro-components-cards'), $theme_version . '.' . filemtime(get_template_directory() . '/assets/css/paket-usaha.css'));
